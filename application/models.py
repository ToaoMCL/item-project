...
class Attributes(db.Model):
    ...
    items = db.relationship("ItemAttributes", backref="attributes", cascade="all,delete")

class ItemTypes(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(25), nullable=False)
    items = db.relationship("Items", backref="item_types", cascade="all,delete")
...
class Items(db.Model):
    ...
    items = db.relationship("ItemAttributes", backref="items",cascade="all,delete")
